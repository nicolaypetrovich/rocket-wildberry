...
<div class="basket_box_inner">
    ...
    <div class="basket_box">
        <div class="basket_info">
						...
						foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
							...
							if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                                ...
                                <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                                    ...
                                    <td class="product-thumbnail cell1"><?php
                                    ...
                                    <td class="product-quantity cell3"
                                        data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>"><?php
            ...
            <div class="basket_button">
                <button class="purple_btn">Оформить заказ</button>
            </div>
        </div>
    ...
    <div class="delivery_free">
        <span>Добавьте товара на<span
                    class="decor"> 320 грн,</span> чтобы получить бесплатную доставку по Николаеву</span>
    </div>
</div>
